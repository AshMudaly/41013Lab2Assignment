...
%% CreateModel
        function CreateModel(self)       
            link(1) = Link('d',0,'a',0.1,'alpha',-pi/2,'offset',0,'qlim',[deg2rad(-180),deg2rad(180)]);
            ...
            link(5) = Link('d',0,'a',0.1,'alpha',0,'offset',0,'qlim',[deg2rad(-180),deg2rad(180)]);
            link(6) = Link('d',0,'a',0.1,'alpha',0,'offset',0,'qlim',[deg2rad(-180),deg2rad(180)]);
